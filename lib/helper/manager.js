...
import { HELPER_STDERR_MAX_BYTES, RemoteHelperInstaller, assertSshAlias, buildHelperConnectCommand, buildSystemSshArgs, detectSshCapabilities, redactHelperDiagnostic, } from './installer.js';
...
export class RemoteHelperManager {
    ...
    async connect(entry, generation) {
        ...
        try {
            ...
            this.assertCurrent(entry, generation);
            const args = buildSystemSshArgs(entry.alias, buildHelperConnectCommand(this.installer.asset.sha256), capabilities);
